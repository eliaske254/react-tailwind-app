  ...
  return (
    <div name="pricing"className='w-full text-white my-24'>
        ...
        <div className='max-w-[1240px] mx-auto py-12'>
            ...
            <p className='text-3xl'>Lorem ipsum dolor sit amet consectetur adipisicing 
                elit. Aliquid, dolores ullam minus eveniet ab vitae
            </p>
            ...
            <div className='grid md:grid-cols-2'>
                ...
                <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
                    <span className='uppercase px-3 py-1 bg-blue-200 text-blue-900 rounded-2xl text-sm'>Standard</span>
                    <div>
