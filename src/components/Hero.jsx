  ...
  return (
    <div name='home' className='w-full h-screen bg-zinc-200 flex flex-col justify-between'>
        <div className='grid md:grid-cols-2 max-w-[1240px] m-auto'>
            <div className='flex flex-col justify-center md:items-start w-full px-2 py-8 pt-20'>
                <p className='text-2xl'>Laundry services at your doorstep</p>
                <h1 className='py-3 text-5xl md:text-7xl font-bold'>Professional Drycleaning</h1>
                <p className='text-2xl'>Your satisfaction is our priority.</p>
                <button className='py-3 px-6 sm:w-[60%] my-4'>LAUNDRY</button>
            </div>
            <div>
